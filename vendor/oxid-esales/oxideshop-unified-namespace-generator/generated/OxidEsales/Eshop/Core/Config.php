 ...
 * The class oxconfig is deprecated since OXID eShop v6.0.0 and should not be used any more as it
 * will be removed in the future.
 * Please use \OxidEsales\Eshop\Core\Config instead.
 */
class_alias(\OxidEsales\Eshop\Core\Config::class, 'oxconfig');
