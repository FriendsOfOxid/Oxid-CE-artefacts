 ...
 * The class oxsystemeventhandler is deprecated since OXID eShop v6.0.0 and should not be used any more as it
 * will be removed in the future.
 * Please use \OxidEsales\Eshop\Core\SystemEventHandler instead.
 */
class_alias(\OxidEsales\Eshop\Core\SystemEventHandler::class, 'oxsystemeventhandler');
