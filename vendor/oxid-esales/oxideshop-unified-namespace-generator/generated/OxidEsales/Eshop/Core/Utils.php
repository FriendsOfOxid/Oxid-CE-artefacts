 ...
 * The class oxutils is deprecated since OXID eShop v6.0.0 and should not be used any more as it
 * will be removed in the future.
 * Please use \OxidEsales\Eshop\Core\Utils instead.
 */
class_alias(\OxidEsales\Eshop\Core\Utils::class, 'oxutils');
